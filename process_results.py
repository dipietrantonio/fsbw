...
with open("results_single_node_seq_write.bin", "rb") as fp:
    res = pickle.load(fp)
...
plt.title("Average bandwidth (and stddev) reached by writing a file sequentially.")
